...
const DailyEmojiGuesser = () => {
  ...
  const emojiChallenges = useMemo(() => [
    ...
    { emojis: '🍎📱', answer: 'APPLE', category: 'Tech Brand', hint: 'Think different device maker' },
    ...
    { emojis: '🍭💀', answer: 'CANDY CRUSH', category: 'Mobile Game', hint: 'Sweet matching puzzle game' },
    { emojis: '👨‍🔬🧪🧠', answer: 'OPPENHEIMER', category: 'Movie', hint: 'Scientist-Chemical-Brain - father of the atomic bomb' },
    { emojis: '🌆🦇🕶️', answer: 'THE DARK KNIGHT', category: 'Movie', hint: 'Batman faces his toughest challenge' },
    { emojis: '🧙‍♂️⚡📚', answer: 'HARRY POTTER', category: 'Book', hint: 'Wizard-Lightning-Book - magical school adventures' },
    { emojis: '💍👑📖', answer: 'LORD OF THE RINGS', category: 'Book', hint: 'Epic fantasy quest to destroy a powerful artifact' },
    ...
    { emojis: '🔔🤢', answer: 'BELLYACHE', category: 'Billie Eilish Song', hint: 'Early hit about stomach pain' },
    ...
    { emojis: '⭐💰', answer: 'STARBUCKS', category: 'Coffee Brand', hint: 'Coffee chain with a green mermaid logo' },
    { emojis: '🎯🎯', answer: 'TARGET', category: 'Retail Brand', hint: 'Retailer known for its bullseye logo' },
    ...
    { emojis: '💍👑', answer: 'LORD OF THE RINGS', category: 'Movie', hint: 'Epic journey to destroy a powerful artifact' },
    ...
    { emojis: '🌍4️⃣👁️🅰️Ⓜ️', answer: 'THEREFORE I AM', category: 'Billie Eilish Song', hint: 'Song with a philosophical title about existence' },
    ...
    { emojis: '👻🚫', answer: 'GHOSTBUSTERS', category: 'Movie', hint: 'Specter-stopping team - who you gonna call?' },
    { emojis: '🐈‍⬛📋', answer: 'COPYCAT', category: 'Billie Eilish Song', hint: 'Imitation isn\'t flattery' },
